//Made by Leif (@Leifstout)
//Modified by Joseph (@BreakLoop)

const fs = require("fs");
const path = require("path");

const BASE_PATH = path.join(__dirname, "../Source");

const BLACKLISTED_DIRS = [
  toPosix(path.join(BASE_PATH, "Interface")),
...
const tree = {
  ...
  tree: {
    ...
    ServerScriptService: {
      Server: { $path: "Source/Startup/Init.server.luau", },
      Services: { $className: "Folder", },
      Classes: { $className: "Folder", },
      Modules: { $className: "Folder", },
    },
